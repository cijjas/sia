...
def main():
    ...
    ax_sigmoid = axes[0]
    ax_sigmoid.plot(perceptron_linear.loss_history, label='Linear Perceptron', color='black')

    i = 0
    for perceptron, fn, beta in non_linear_perceptrons:
        if fn == 'sigmoid':
            ax_sigmoid.plot(perceptron.loss_history, label=f'Sigmoid beta={beta}', color=colors[i])
            i += 1
    ...
    ax_tanh = axes[1]
    ax_tanh.plot(perceptron_linear.loss_history, label='Linear Perceptron', color='black')

    i = 0
    for perceptron, fn, beta in non_linear_perceptrons:
        if fn == 'tanh':
            ax_tanh.plot(perceptron.loss_history, label=f'Tanh beta={beta}', color=colors[i])
            i += 1
    ...
    ax_relu = axes[2]
    ax_relu.plot(perceptron_linear.loss_history, label='Linear Perceptron', color='black')
