...
from utils.genetic_config import GAConfig, SelectionMethod
...
def selection_method_comparison():
    ...
    config: GAConfig = config_loader.load()
    ...
    for parent_selection_method in selection_methods:
        for replacement_selection_method in selection_methods:
            config.parents_selection_methods = [SelectionMethod(parent_selection_method)]
            config.replacements_selection_methods = [SelectionMethod(replacement_selection_method)]
